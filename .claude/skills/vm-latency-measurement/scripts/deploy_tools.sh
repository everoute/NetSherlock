...
#   - kvm_vhost_tun_latency_details.py: kvm-virt-network/vhost-net/
...
KVM_VHOST_TUN_LATENCY="${LOCAL_TOOLS}/kvm-virt-network/vhost-net/kvm_vhost_tun_latency_details.py"
...
echo "  - kvm_vhost_tun_latency_details.py -> /tmp/"
